...
const QUIZ = [
  ...
  { q: "Event 4624 with LogonType 9 (NewCredentials) indicates:",
    o: ["RunAs /netonly — alternate credentials used for remote access", "A scheduled task ran", "An RDP session", "A failed logon"], a: 0, tag: "Events",
  ...
  { q: "Event 4728 records:",
    o: ["A user added to a security-enabled global group (e.g. Domain Admins)", "A user account was created", "A password was reset", "A logon failure"], a: 0, tag: "Events",
  ...
  { q: "Event 4732 records:",
    o: ["A user added to a domain-local group (e.g. local admins / RDP)", "A service installed", "An account locked out", "A DNS query"], a: 0, tag: "Events",
  ...
  { q: "Event 4740 fires when:",
    o: ["An account is locked out", "A user logs on successfully", "A process starts", "A share is accessed"], a: 0, tag: "Events",
  ...
  { q: "Event 4647 indicates:",
    o: ["A user initiated logoff", "An account was created", "A privilege was assigned", "A password expired"], a: 0, tag: "Events",
    e: "4647 = user-initiated logoff. Missing 4647 after a successful 4624 may hint at a killed session." },
  { q: "Event 4768 is a:",
    o: ["Kerberos TGT request (AS-REQ)", "Kerberos service ticket request (TGS-REQ)", "NTLM logon", "LDAP bind"], a: 0, tag: "Events",
  ...
  { q: "Event 4771 indicates:",
    o: ["Kerberos pre-authentication failed", "Successful Kerberos authentication", "Account lockout", "Password change"], a: 0, tag: "Events",
    e: "4771 = pre-auth failure. A spike of 4771 for one account = Kerberos password spray (T1110.002)." },
  { q: "Event 5140 records:",
    o: ["A network share object was accessed", "A user was added to a group", "A file was deleted", "A service started"], a: 0, tag: "Events",
  ...
  { q: "Event 4723 vs 4724:",
    o: ["4723 = self-service password change; 4724 = admin reset attempt", "4723 = lockout; 4724 = unlock", "They mean the same thing", "4723 = group change; 4724 = user change"], a: 0, tag: "Events",
  ...
  { q: "A burst of 4625 failures with Status 0xC000006D (bad username) against many different names suggests:",
    o: ["Username enumeration / spraying", "A normal maintenance script", "A lockout policy problem", "Kerbéros misconfiguration"], a: 0, tag: "Events",
  ...
  { q: "Event 4657 records:",
    o: ["A registry value modification", "A process creation", "An email delivery", "A network connection"], a: 0, tag: "Events",
  ...
  { q: "Event 7036 records:",
    o: ["A service state change (started / stopped)", "A user logon", "A scheduled task creation", "A firewall change"], a: 0, tag: "Events",
  ...
  { q: "Sysmon Event ID 6 logs:",
    o: ["Driver loaded", "Process image loaded into memory", "Named pipe", "DNS query"], a: 0, tag: "Sysmon",
  ...
  { q: "Sysmon Event ID 7 logs:",
    o: ["ImageLoaded (DLL mapped into a process)", "Registry change", "Network connection", "File created"], a: 0, tag: "Sysmon",
  ...
  { q: "Sysmon Event IDs 12 / 13 / 14 cover:",
    o: ["Registry create / value set / key rename", "Scheduled tasks", "Service installation", "Named pipes"], a: 0, tag: "Sysmon",
  ...
  { q: "Sysmon Event IDs 17 / 18 log:",
    o: ["Named pipe created / connected", "Process injection", "Clipboard changes", "File deletion"], a: 0, tag: "Sysmon",
  ...
  { q: "Sysmon Event ID 23 logs:",
    o: ["File delete (archived)", "File creation", "Process access", "DNS query"], a: 0, tag: "Sysmon",
  ...
  { q: "Sysmon Event ID 25 logs:",
    o: ["Process tampering (PATCH / code modified)", "Driver load", "Service install", "WMI event"], a: 0, tag: "Sysmon",
  ...
  { q: "Sysmon Event ID 26 logs:",
    o: ["File delete detected (with file path)", "Process created", "Service stopped", "Log cleared"], a: 0, tag: "Sysmon",
    e: "EID 26 = FileDeleteDetected. Combines with 23 for covering-tracks forensics (T1070.004)." },
  { q: "Sysmon Event ID 3 records:",
    o: ["Source/dest IP, ports, protocol, and the owning process", "Only the process name", "Only the destination port", "The full URL visited"], a: 0, tag: "Sysmon",
  ...
  { q: "To detect a process creating a remote thread inside another process (injection), use Sysmon:",
    o: ["8 (CreateRemoteThread)", "15 (FileCreateStreamHash)", "24 (ClipboardChange)", "26 (FileDeleteDetected)"], a: 0, tag: "Sysmon",
  ...
  { q: "The FIRST question an L1 should ask on any alert is:",
    o: ["Is this real, and what evidence supports it?", "Can I block the IP?", "Who is the SOC manager?", "How do I close this fast?"], a: 0, tag: "Triage",
  ...
  { q: "The correct triage sequence is:",
    o: ["Validate → enrich → build timeline → classify → escalate", "Escalate → validate → close", "Block → isolate → investigate", "Ignore → document → close"], a: 0, tag: "Triage",
  ...
  { q: "A timeline in triage should:",
    o: ["Reconstruct the attack chain chronologically across all log sources", "Show only the current alert", "List only blocked attempts", "Show only successful logons"], a: 0, tag: "Triage",
  ...
  { q: "Two alerts on different hosts share one source IP. The L1 should:",
    o: ["Correlate them — one actor or one campaign", "Close both as duplicates", "Handle only the newest one", "Ignore the IP"], a: 0, tag: "Triage",
  ...
  { q: "The purpose of evidence collection during triage is:",
    o: ["To let L2/IR act immediately without re-triaging", "To fill disk space", "To prove the analyst worked", "To delay escalation"], a: 0, tag: "Triage",
  ...
  { q: "A false negative is the most dangerous outcome because:",
    o: ["Real malicious activity was missed entirely", "It fires too often", "It blocks legitimate users", "It uses too much CPU"], a: 0, tag: "Triage",
  ...
  { q: "Alert fatigue is best addressed by:",
    o: ["Rule tuning, deduplication, and risk-based prioritization", "Deleting the SIEM", "Hiring staff to read everything", "Disabling alerts"], a: 0, tag: "Triage",
  ...
  { q: "An L1 ticket should be:",
    o: ["Structured, objective, evidence-backed, and escalation-ready", "A long stream of consciousness", "A single sentence", "Only the alert ID"], a: 0, tag: "Triage",
  ...
  { q: "Dwell time measures:",
    o: ["Time from initial compromise to detection", "Time to respond to an alert", "Time to patch a server", "Time to write a ticket"], a: 0, tag: "Concepts",
    e: "Dwell time = how long an attacker was inside before detection. Reducing it is a core SOC goal." },
  { q: "MTTD stands for:",
    o: ["Mean Time To Detect", "Mean Time To Deploy", "Minimum Time To Diagnose", "Median Time To Dismiss"], a: 0, tag: "Concepts",
    e: "MTTD = how fast the SOC detects incidents — measured from compromise to detection." },
  { q: "MTTR stands for:",
    o: ["Mean Time To Respond / Recover", "Most Time To React", "Minimum Time To Reboot", "Mean Total Time Recorded"], a: 0, tag: "Concepts",
  ...
  { q: "In the cyber kill chain, 'Actions on Objectives' follows:",
    o: ["Command & Control", "Reconnaissance", "Delivery", "Exploitation"], a: 0, tag: "Concepts",
    e: "Order: Recon → Weaponize → Deliver → Exploit → Install → C2 → Actions on Objectives." },
  { q: "The Diamond Model's four vertices are:",
    o: ["Adversary, Infrastructure, Capability, Victim", "Host, Network, User, Data", "Attacker, Target, Time, Place", "Malware, Phishing, Ransomware, DDoS"], a: 0, tag: "Concepts",
    e: "Diamond = Adversary + Infrastructure + Capability + Victim. Great for structuring correlations." },
  { q: "Defense in depth means:",
    o: ["Multiple overlapping security layers so a single failure isn't fatal", "One very strong firewall", "More passwords", "Encrypting all traffic"], a: 0, tag: "Concepts",
  ...
  { q: "For a credential-based attack, the FIRST logs to review are:",
    o: ["Authentication logs (4624 / 4625, 4768/4769)", "Web access logs", "Anti-virus logs", "Physical access logs"], a: 0, tag: "Concepts",
  ...
  { q: "In a SOC, 'alert triage' refers to:",
    o: ["Sorting and validating alerts to decide whether action is needed", "Writing detection rules", "Configuring the SIEM", "Running phishing simulations"], a: 0, tag: "Concepts",
  ...
  { q: "Exploiting a public-facing application maps to which technique?",
    o: ["T1190", "T1547.001", "T1566.002", "T1053.005"], a: 0, tag: "MITRE",
    e: "T1190 = Exploit Public-Facing Application (e.g. SQLi, RCE on a portal)." },
  { q: "TA0002 is which MITRE tactic?",
    o: ["Execution", "Persistence", "Discovery", "Lateral Movement"], a: 0, tag: "MITRE",
    e: "TA0002 = Execution — running attacker code (PowerShell, schtasks, services)." },
  { q: "T1059.001 is:",
    o: ["PowerShell (Command and Scripting Interpreter)", "Scheduled Task", "Registry Run Keys", "Windows Service"], a: 0, tag: "MITRE",
  ...
  { q: "Which tactic covers moving from one host to another?",
    o: ["TA0008 Lateral Movement", "TA0003 Persistence", "TA0005 Defense Evasion", "TA0004 Privilege Escalation"], a: 0, tag: "MITRE",
    e: "TA0008 = Lateral Movement (SMB, RDP, WinRM, PsExec)." },
  { q: "Clearing the Windows Security log maps to:",
    o: ["T1070.001", "T1059.001", "T1105", "T1490"], a: 0, tag: "MITRE",
  ...
  { q: "Bringing tools onto a compromised host (download cradle, payload) is:",
    o: ["T1105 Ingress Tool Transfer", "T1071.001", "T1041", "T1568.002"], a: 0, tag: "MITRE",
    e: "T1105 = Ingress Tool Transfer — curl/PowerShell/BITS pulling attacker tooling." },
  { q: "Valid Accounts (T1078) is dangerous because:",
    o: ["It uses legitimate credentials that blend into normal traffic", "It is easy to block", "It only works on Linux", "It is always detected"], a: 0, tag: "MITRE",
  ...
  { q: "Lateral movement via RDP maps to:",
    o: ["T1021.001", "T1021.002", "T1558.003", "T1190"], a: 0, tag: "MITRE",
    e: "T1021.001 = Remote Services: RDP. Watch 4624 LogonType 10 to non-standard hosts." },
  { q: "The P2 acknowledge SLA is:",
    o: ["30 minutes", "15 minutes", "2 hours", "8 hours"], a: 0, tag: "Severity",
  ...
  { q: "Severity is about ____; Priority is about ____.",
    o: ["Technical impact / business urgency", "Business urgency / technical impact", "Money / time", "Detection / response"], a: 0, tag: "Severity",
  ...
  { q: "A P3 alert fires on a Domain Controller (Tier 0). Final priority?",
    o: ["Rises — tier multiplier pushes it to P2/P1", "Drops to P4", "Stays P3", "Becomes a non-event"], a: 0, tag: "Severity",
  ...
  { q: "The SLA clock for an alert starts:",
    o: ["When the alert fires / is assigned to the queue", "When L2 escalates", "At end of shift", "When the ticket is closed"], a: 0, tag: "Severity",
  ...
  { q: "An acknowledged SLA being missed should:",
    o: ["Trigger an escalation path / manager notification", "Be ignored", "Be deleted", "Wait until the next day"], a: 0, tag: "Severity",
    e: "Missed SLAs auto-escalate in mature SOCs so incidents never fall through the cracks." },
  { q: "Which of these is a P1 event?",
    o: ["Domain-wide credential compromise / ransomware", "A single phishing email (no click)", "A known false positive", "A disk space warning"], a: 0, tag: "Severity",
  ...
  { q: "TCP/UDP port 53 carries:",
    o: ["DNS", "HTTP", "FTP", "NTP"], a: 0, tag: "Network",
    e: "53 = DNS. Watch for tunneling (TXT/long labels), DGA NXDOMAIN storms, and odd query volumes." },
  { q: "A beacon with jitter is:",
    o: ["A C2 check-in with a randomized delay to evade fixed-interval detection", "A legal compliance tool", "An EDR heartbeat", "A DNS request"], a: 0, tag: "Network",
  ...
  { q: "NetFlow / IPFIX records show:",
    o: ["Conversation metadata (5-tuple, bytes, duration) — not full payloads", "Full packet payloads", "Decrypted HTTPS", "User passwords"], a: 0, tag: "Network",
  ...
  { q: "Outbound traffic from a web server to an external MSSQL port (1433) is:",
    o: ["Suspicious — MSSQL to the internet is rarely legitimate", "Normal — everyone does this", "Only suspicious on Linux", "Fine if it is UDP"], a: 0, tag: "Network",
  ...
  { q: "An NDR (Network Detection and Response) tool detects:",
    o: ["Network-based threats via packet/flow analysis and ML", "Only firewall configs", "Only WiFi issues", "Endpoint malware execution"], a: 0, tag: "Network",
  ...
  { q: "Port scanning originating from an internal host typically means:",
    o: ["A compromised host doing reconnaissance", "Normal backup activity", "A VPN issue", "Email scanning"], a: 0, tag: "Network",
  ...
  { q: "Without TLS decryption, HTTPS traffic visibility is limited to:",
    o: ["IPs, ports, SNI, TLS fingerprints, and connection metadata", "The full URL and query string", "HTTP headers", "Response bodies"], a: 0, tag: "Network",
  ...
  { q: "Cross-Site Scripting (XSS) is best detected by looking for:",
    o: ["<script> tags or encoded JS in requests/responses", "UNION SELECT", "Very long passwords", "Large downloads"], a: 0, tag: "Web",
  ...
  { q: "An IDOR / BOLA vulnerability lets an attacker:",
    o: ["Access another user's objects by changing an identifier (account=1234)", "Infect the server", "Clear logs", "Steal an MFA token"], a: 0, tag: "Web",
  ...
  { q: "Server-Side Request Forgery (SSRF) allows an attacker to:",
    o: ["Make the server fetch internal resources on their behalf", "Spoof their client IP", "Guess passwords", "Resolve domains"], a: 0, tag: "Web",
  ...
  { q: "Which response header blocks clickjacking (page framing)?",
    o: ["X-Frame-Options / CSP frame-ancestors", "Strict-Transport-Security", "Server", "X-Powered-By"], a: 0, tag: "Web",
  ...
  { q: "A request containing \"UNION SELECT ... FROM information_schema\" indicates:",
    o: ["SQL injection", "A normal health check", "XSS", "CSRF"], a: 0, tag: "Web",
    e: "information_schema queries are classic SQLi schema enumeration (T1190 / injection)." },
  { q: "CSRF attacks rely on:",
    o: ["The victim's browser sending an authenticated request unknowingly", "Brute-forcing passwords", "SQL injection", "A compromised certificate"], a: 0, tag: "Web",
  ...
  { q: "An HTTP 500 after an attacker's SQLi payload suggests:",
    o: ["The query may have executed and crashed — investigate further", "The attack failed and is harmless", "The server is offline", "A network issue"], a: 0, tag: "Web",
  ...
  { q: "On Linux, which file holds password hashes (root-only)?",
    o: ["/etc/shadow", "/etc/passwd", "/etc/hosts", "/etc/resolv.conf"], a: 0, tag: "Linux",
    e: "/etc/shadow = hashes (root). Reading it = hash dump attempt (T1003.008)." },
  { q: "A cron job running /tmp/xmrig every minute indicates:",
    o: ["Crypto-mining persistence", "A legitimate backup", "Package updates", "Log rotation"], a: 0, tag: "Linux",
    e: "/tmp binaries + cron = miner persistence (T1053.003 + T1496)." },
  { q: "sshd logs authentication failures to:",
    o: ["/var/log/auth.log (or /var/log/secure)", "/var/log/nginx/access.log", "/var/log/kern.log", "/var/log/dmesg"], a: 0, tag: "Linux",
  ...
  { q: "A new entry in ~/.ssh/authorized_keys is a sign of:",
    o: ["Persistence via a backdoor SSH key", "Normal user activity", "SSH server patching", "Disk cleanup"], a: 0, tag: "Linux",
  ...
  { q: "Which command lists running processes on Linux?",
    o: ["ps aux / top", "dir", "ipconfig", "regedit"], a: 0, tag: "Linux",
  ...
  { q: "High CPU plus outbound connections to port 3333 (mining pools) indicates:",
    o: ["Resource hijacking (crypto mining)", "A web server", "An SSH tunnel", "A DNS server"], a: 0, tag: "Linux",
  ...
  { q: "In Azure/Entra ID, which log best captures sign-in anomalies (impossible travel, MFA failure)?",
    o: ["Sign-in logs (Interactive user sign-ins)", "Azure activity log", "Storage access logs", "VNet flow logs"], a: 0, tag: "Cloud",
  ...
  { q: "An AWS access key starting with AKIA pasted in a public repo is:",
    o: ["A leaked long-term credential — revoke and rotate", "A harmless test key", "An instance role", "A session token"], a: 0, tag: "Cloud",
  ...
  { q: "An OAuth app requesting 'Mail.Read' for a user's mailbox is:",
    o: ["A common consent-phishing / exfiltration primitive", "Always safe", "Only possible on Linux", "Impossible"], a: 0, tag: "Cloud",
  ...
  { q: "Conditional Access policies in Entra ID allow you to:",
    o: ["Enforce MFA on risky sign-ins and block legacy auth", "Change passwords", "Patch servers", "Configure DNS"], a: 0, tag: "Cloud",
  ...
  { q: "A service principal performing mass password writes is:",
    o: ["Suspicious — investigate (credential-stuffing vector)", "Normal scheduled maintenance", "The weekly backup", "A DNS update"], a: 0, tag: "Cloud",
  ...
  { q: "An S3 bucket policy changed to public followed by large downloads is:",
    o: ["Data exposure / exfiltration via cloud storage", "Normal operations", "A CDN pre-warm", "A compliance audit"], a: 0, tag: "Cloud",
